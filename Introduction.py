...
async def app():
  ...
  question = """Follow recommend content of the risk registry exactly.  Create a risk registry for the 
    Management Information System Office. Format the output as a table. Omit all other output text and return only the table. Return the table as a numpy array."""
